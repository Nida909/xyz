...
public class LocatioTrackerService extends Service {
    private FusedLocationProviderClient mLocationProviderClient;
    private LocationCallback locationUpdatesCallback;
    private LocationRequest locationRequest;
    public LocatioTrackerService() {
    }
    ...
    public void onDestroy() {
        ...
        //database.getReference().child("location").removeValue();
        DatabaseReference reference = FirebaseDatabase.getInstance().getReference("location").child("device1");
        ...
        locationUpdatesCallback = new LocationCallback(){
            ...
            public void onLocationResult(LocationResult locationResult) {
                if(locationResult!=null){
                    ...
                    LocationNotification.notify(LocatioTrackerService.this, "Location Tracking",
